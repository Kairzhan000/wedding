...
document.addEventListener('DOMContentLoaded', function() {
    ...
    ru: {
      ...
      hero_date: '1 августа 2025', scroll: 'Листай',
      ...
      det_ceremony: 'Церемония', det_ceremony_p: 'Место проведения церемонии<br>Адрес, город',
      det_banquet: 'Банкет', det_banquet_p: 'Название ресторана<br>Адрес, город',
      ...
      c1: 'Молоко', c2: 'Льняной', c3: 'Шампань', c4: 'Золото', c5: 'Бронза',
      rsvp_label: 'Подтверждение', rsvp_title: 'Будете ли вы с нами?',
      rsvp_desc: 'Пожалуйста, подтвердите своё присутствие до 15 июля 2025',
    ...
    kz: {
      ...
      hero_date: '1 тамыз 2025', scroll: 'Айналдыр',
      ...
      det_ceremony: 'Салтанатты рәсім', det_ceremony_p: 'Салтанат өтетін орын<br>Мекенжай, қала',
      det_banquet: 'Банкет', det_banquet_p: 'Мейрамхана атауы<br>Мекенжай, қала',
      ...
      rsvp_desc: '2025 жылғы 15 шілдеге дейін қатысуыңызды растаңыз',
